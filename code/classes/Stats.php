...
class Stats
{
	...
	{
		$extensions = $dates = $unique_hits = $countries = [];
		$total_hits = 0;
		global $config;
		...
		fclose($h);
		$this -> num_days = is_countable($dates) ? count($dates) : 0;
